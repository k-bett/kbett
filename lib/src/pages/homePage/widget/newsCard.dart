...
class NewsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        // Update navigation to other relevant pages if needed
        Navigator.pushNamed(context, '/video', arguments: artical.videoId);
      },
      child: Container(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: artical.urlToImage == null || artical.urlToImage.isEmpty
                          ? Container()
